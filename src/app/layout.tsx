...
// Lazy load the LoadingPage component
...
export default function RootLayout({
  ...
  // Handle navigation and loading state
  useEffect(() => {
    ...
    // If navigating to home page from another page, show loading
            ...
            {isOpen && (
              <Card className="w-80 shadow-xl bg-white">
                <CardContent className="p-4 flex flex-col space-y-2 justify-center">
                  ...
                  <div className="max-h-[280px] min-h-[280px] flex-1 overflow-y-auto p-4 space-y-4 cursor-default">
