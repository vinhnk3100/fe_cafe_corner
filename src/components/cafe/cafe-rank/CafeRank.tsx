  ...
  if (cafeCOTYData) {
    return (
      <Link href={`cafes/${cafeCOTYData.id}`}>
        <motion.div
          className="relative items-center flex flex-row justify-between gap-6 w-full h-full rounded-lg overflow-hidden bg-gradient-to-br from-gray-800 to-gray-900 shadow-lg group group hover:shadow-[0_0_30px_15px_rgba(252,211,77,0.5)] transition-all duration-500"
